                        ...
                        <li className="relative px-3">
                            ...
                            <div id="AuthDropdown" className="hidden absolute bg-white w-[200px] text-[#333333] z-40 top-[20px] left-0 border shadow-lg">
                                <div className="flex items-center justify-start gap-1 p-3">
                                    ...
                                    <div className="font-bold text-[13px]"> Ibrahim Ajmal </div> 
                                </div>

                                <div className="border-b">
                                    <ul className="bg-white">
                                        <li className="text-[11px] py-2 px-4 w-full hover:underline text-blue-500 hover-blue-600 cursor-pointer">
                                            <Link href="/orders">
                                                My Orders
                                            </Link>
                                        </li>
