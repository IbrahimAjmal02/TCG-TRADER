...
export default function SubMenuMenu() {
    const menuItems = [
        { id: 1, name: 'Home' },
        { id: 2, name: 'Saved' },
    ...
    return (
        <>
            <div id="SubMenu" className='border-b'>
                <div className="flex items-center justify-between w-full mx-auto max-w-[1200]px">
                    <ul className="flex iems-center text-[13px] text-[#333333] px-2 h-8">
                        {menuItems.map(item => (                        
